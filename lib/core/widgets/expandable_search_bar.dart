  ...
  void initState() {
    ...
    _widthAnimation =
        Tween<double>(
          ...
          end: 150.0, // Width khi mở rộng - giảm để tránh overflow
        ).animate(
          CurvedAnimation(
      ...
      if (_focusNode.hasFocus) {
        ...
        Future.delayed(const Duration(milliseconds: 300), () {
          if (mounted && !_isInteracting && !_isDropdownOpen) {
            ...
            _collapse(); // Thu lại search bar khi mất focus
          }
        });
      }
    });
    ...
    return PopupMenuItem<String>(
      ...
      child: Row(
        children: [
          ...
          if (_searchType == type) const Spacer(),
          if (_searchType == type)
  ...
  Widget _buildSearchResultsList() {
    ...
    return ListView.separated(
      ...
      separatorBuilder: (context, index) =>
          const SizedBox.shrink(), // Không có separator vì đã có border
            ...
            Container(
              ...
              child: ClipRRect(
                ...
                child: book.coverImageUrl != null
                    ...
                    : const Icon(Icons.book, size: 35, color: Colors.grey),
              ),
            ),
