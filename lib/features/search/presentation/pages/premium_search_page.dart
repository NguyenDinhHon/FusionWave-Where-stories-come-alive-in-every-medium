...
/// Premium Search Page với design giống Wattpad & Waka
class PremiumSearchPage extends ConsumerStatefulWidget {
  const PremiumSearchPage({super.key});

  @override
  ConsumerState<PremiumSearchPage> createState() => _PremiumSearchPageState();
}

class _PremiumSearchPageState extends ConsumerState<PremiumSearchPage> {
              ...
              if (_authorFilter != null && _authorFilter!.isNotEmpty) {
                filteredBooks = filteredBooks.where((book) {
                  return book.authors.any((author) => 
                    author.toLowerCase().contains(_authorFilter!.toLowerCase()));
                }).toList();
              }
              ...
              filteredBooks.sort((a, b) {
                switch (_sortBy) {
                  ...
                  default: // relevance
                    ...
                    final scoreA = (a.averageRating ?? 0) * 0.6 + (a.totalReads / 1000) * 0.4;
                    final scoreB = (b.averageRating ?? 0) * 0.6 + (b.totalReads / 1000) * 0.4;
