...
/// BookDetailPage với design giống Wattpad & Waka
...
class _BookDetailPageState extends ConsumerState<BookDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final libraryItemAsync = ref.watch(
      libraryItemByBookIdProvider(widget.bookId),
    );
            ...
            data: (userRating) {
              ...
              return Column(
                children: [
                  ...
                  if (userRating.review != null &&
                      userRating.review!.isNotEmpty) ...[
                    const SizedBox(height: 8),
                    InteractiveButton(
                      label: 'Edit Review',
                      icon: Icons.edit,
                        ...
                        child: FadeInAnimation(
                          child: Container(
                            margin: EdgeInsets.only(
                              bottom: index < displayReviews.length - 1
                                  ? 16
                                  : 0,
                            ),
                            padding: const EdgeInsets.all(16),
